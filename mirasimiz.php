...
<div class="jumbotron mirasimizJumbotron">
	<div class="container">
		
		<br><br>
		<p class="text-dark text-center baslik">GEZİLEBİLECEK YERLER</p>
		<br><br>

	</div>
</div>

<div class="jumbotron mirasimizJumbotronbilgi">
	<div class="container">
		...
		<div class="text-center marginAuto">
			...
			Caminin içerisindeki minber, avize ve balkonu da döneme ait orijinal parçalardır.</h5>
			<h5>17 Ağustos depremi sırasında hasar görmüş ve minaresi yıkılmıştır, tekrardan onarımla restore edilmiştir.</h5>
			...
			<h5> Yaklaşık olarak 365 metre uzunluğa sahip olup köprü, yapıldığı dönem itibariyle kullanılan mimari ve tekniğin altında yatan uzmanlığı ile
			muhteşem bir örnek teşkil etmektedir.</h5>
			<h5>Köprünün; doğu ve batı topraklarını tekrardan bir araya getirmek gibi bir amacı temsil etmektedir. </h5>
		</div>
		<br>
		<br>
	</div>
